...
const Home = () => {
  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <p className='text-2xl text-blue-400'>Hi, my name is</p>
        <h1 className='text-4xl sm:text-7xl font-bold text-[#ffffff]'>
          Cameron Dyas
        </h1>
        <h2 className='text-4xl sm:text-7xl font-bold text-[#77809b]'>
          I'm a Full Stack Developer.
        </h2>
        <p className='text-[#a6afc9] text-[23px] py-4 max-w-[700px]'>
